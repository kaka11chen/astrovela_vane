...
from vane.experimental.spark.conf import SparkConf
from vane.experimental.spark.exception import ContributionsAcceptedError


class SparkContext:  # noqa: D101
    def __init__(self, master: str) -> None:  # noqa: D107
        self._connection = vane.connect(":memory:")
    ...
    #     ) -> vane.experimental.spark.rdd.RDD[typing.Tuple[str, bytes]]:
    # 	pass

    # def binaryRecords(self, path: str, recordLength: int) -> vane.experimental.spark.rdd.RDD[bytes]:
    # 	pass
    ...
    # def emptyRDD(self) -> vane.experimental.spark.rdd.RDD[typing.Any]:
    # 	pass
    ...
    # def statusTracker(self) -> vane.experimental.spark.status.StatusTracker:
    # 	raise ContributionsAcceptedError
