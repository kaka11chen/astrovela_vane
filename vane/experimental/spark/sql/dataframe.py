...
import vane
from vane import ColumnExpression, Expression, StarExpression
...
from vane.experimental.spark.sql import functions as spark_sql_functions


class DataFrame:  # noqa: D101
    def __init__(self, relation: vane.DuckDBPyRelation, session: "SparkSession") -> None:  # noqa: D107
    ...
    def schema(self) -> StructType:
        """Returns the schema of this :class:`DataFrame` as a :class:`vane.experimental.spark.sql.types.StructType`.
    ...
    def __getitem__(self, item: int | str | Column | list | tuple) -> Union[Column, "DataFrame"]:
        ...
        if isinstance(item, str):
            return Column(vane.ColumnExpression(self.relation.alias, item))
    ...
    def __getattr__(self, name: str) -> Column:
        ...
        return Column(vane.ColumnExpression(self.relation.alias, name))
